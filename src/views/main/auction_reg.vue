...
<fieldset>
    ...
    <tbody>
        ...
        <td class="table-100-0pky"  colspan="3" ><input id="td_input_text" type="text" name="text" size="20" style="width:100%;" required placeholder="작물을 입력해주세요" v-model="product"></td>
      </tr>
      <tr>
        <td class="table-100-tyfk">중량</td>
        <td class="table-100-0pky" colspan="3" ><input id="td_input_text" type="text" name="text" size="20" style="width:100%;" required placeholder="kg" v-model="product_kg"></td>
      </tr>
      <tr>
        <td class="table-100-tyfk">시작 가격</td>
        <td class="table-100-0pky" colspan="3" ><input id="td_input_text" type="text" name="text" size="20" style="width:100%;" required placeholder="원" v-model="p_starting_price"></td>
      </tr>
      <tr>
        <td class="table-100-tyfk">최대 가격</td>
        <td class="table-100-0pky" colspan="3"><input id="td_input_text" type="text" name="text" size="20" style="width:100%;" required placeholder="원" v-model="p_max_price"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="table-100-1pky"><input type='radio' name="status" v-model="p_status" value="상"> 상</td>
        <td class="table-100-1pky"><input type='radio' name="status" v-model="p_status" value="중"> 중</td>
        <td class="table-100-1pky"><input type='radio' name="status" v-model="p_status" value="하"> 하</td>
      </tr>
      <tr>
        <td class="table-100-tyfk">설명</td>
        <td class="table-100-0pky" colspan="3" ><input id="td_input_text" type="text" name="text" size="20" style="width:100%;" required placeholder="작물의 세부사항을 적어주세요" v-model="p_explanation"></td>
      </tr>
    </tbody>
    </table>
</fieldset>
...
<div class="main_nav_b_div">
    <nav class="main_b_nav">
        <ul class="main_m_ui_list">
            <li class="nav__btn">
                <a class="nav__link" href="#"><h4 class="user-component__title"  @click="submitProduct()">등록하기</h4>
                </a>
            </li>
        </ul>
    </nav>
